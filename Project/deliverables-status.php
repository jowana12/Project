...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/deliverables-status.css">
    ...
    ?>
        ...
        <div class="main-content">
            <?php
                        $dbh = new PDO("mysql:host=localhost;dbnmame=project", "root", "");
                        $id = isset($_GET['id'])? $_GET['id'] : "";
                        $statement = $dbh->prepare("select * from project.deliverables where org_id=? order by days desc");
                        ...
                        <div class='list-info'>
                            ...
                            <div class='profile-container'>
                                ...
                                <p class='profile-content'>".$row['document']."</p>
                            </div>
                            ...
                            <div class='buttons'>
                                <a target='_blank' href='includes/download-file.inc.php?id=".$row['deliverable_id']."'><button class='btn-download'>Download</button></a>
                            </div>
                            </div>
                            </div>
                            <br>
