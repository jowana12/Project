...
<body>
    ...
    ?>
        ...
        <div class="title">
            <h1 class="title-header">Approval of Venue Reservations</h1>
            <hr>
        </div>

        <div class="main-content">
             <img style="width:100%" src="images/errormessages/nopendingapprovalofvenuereservation.png" alt="error-messages">	
        </div>
